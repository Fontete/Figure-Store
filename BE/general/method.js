...
exports.Validator = (req, res, next) => {
    ...
    req.check('password')
        ...
        .withMessage('Password must contain at least 6 characters and less than 32 characters. It must has at least one number, one character and not includes special character');
